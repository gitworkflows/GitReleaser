...
test.serial('should instantiate plugins and execute all release-cycle methods', async t => {
  ...
  sh.exec(`npm link gitreleaser`);
  const content = "import { Plugin } from 'gitreleaser'; " + MyPlugin.toString() + '; export default MyPlugin;';
...
test.serial('should disable core plugins', async t => {
  ...
  const content =
    "import { Plugin } from 'gitreleaser'; " + ReplacePlugin.toString() + '; export default ReplacePlugin;';
...
test.serial('should expose context to execute commands', async t => {
  ...
  const content =
    "import { Plugin } from 'gitreleaser'; " + ContextPlugin.toString() + '; export default ContextPlugin;';
