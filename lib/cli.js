...
const helpText = `GitReleaser! v${pkg.version}

  Usage: gitreleaser <increment> [options]

  Use e.g. "gitreleaser minor" directly as shorthand for "gitreleaser --increment=minor".

  -c --config            Path to local configuration options [default: ".gitreleaser.json"]
  ...
  -v --version           Print gitreleaser version number
...
For more details, please see https://github.com/gitreleaser/gitreleaser`;
