...
const docs = 'https://github.com/release-git/release-git/blob/main/docs/git.mdhub';
...
const truncateBody = body => {
  // https://github.com/release-git/release-git/issues/
...
class GitHub extends Release {
  ...
  get client() {
    ...
    const options = {
      ...
      userAgent: `release-git/${pkg.version}`,
